...
# Catchment data using observed streamflow rather than bc transformed -----------
# probably put this into another file and call it in the main file
# v2 uses observed streamflow rather than boxcox streamflow

## constructor =================================================================
new_catchment_data_blueprint_v2 <- function(gauge_ID, year, precipitation, observed_streamflow, is_drought_year, CO2, seasonal_ratio, start_stop_indexes) {
...
## validator ===================================================================
validate_catchment_data_blueprint_v2 <- function(catchment_data_blueprint) {
  values <- unclass(catchment_data_blueprint)
...
## helper ======================================================================
catchment_data_blueprint_v2 <- function(gauge_ID, observed_data, start_stop_indexes, ...) {
  ...
  # If observed_data is null the user must enter gauge_ID, year, etc. manually
  if (is.null(observed_data)) {
    new_catchment_data_blueprint_v2(
      gauge_ID = gauge_ID,
      year = year,
      precipitation = precipitation,
  ...
  new_catchment_data_blueprint_v2(
    ...
    validate_catchment_data_blueprint_v2()
