...
make_default_bounds_and_transform_methods <- function(catchment_data_set) {
  ...
  # alpha and beta must be scaled based on the maximum observed streamflow
  ...
  tibble::tribble(
    ...
    "a0",           -3000,          4000,                       linear_parameter_transform, # intercept
    ...
    "alpha",         1E-8,          max_observed_streamflow,    linear_parameter_transform, 
    "beta",          1E-8,          max_observed_streamflow,    linear_parameter_transform, 
